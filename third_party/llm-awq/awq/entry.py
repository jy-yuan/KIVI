...
from awq.quantize.quantizer import pseudo_quantize_model_weight, real_quantize_model_weight, real_quantize_model_weight_with_trainable_qlinear
...
def build_model_and_enc(model_path):
    ...
    if args.load_quant:  # directly load quantized weights
        ...
        real_quantize_model_weight_with_trainable_qlinear(
