...
```bash
mkdir quant_cache
python -m awq.entry --model_path huggyllama/llama-7b --w_bit 4 --q_group_size 128  \
    --load_awq awq_cache/llama-7b-w4-g128.pt --q_backend real \
    --dump_quant quant_cache/llama-7b-w4-g128-model-trainable.pt
```
